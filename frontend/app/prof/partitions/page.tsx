...
export default async function Page({ searchParams }: { searchParams: { week?: string; student?: string } }) {
  ...
  return <PartitionDistribution data={response.data} studentId={searchParams.student} />;
}
