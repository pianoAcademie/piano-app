...
const TOPICS: Record<UiLanguage, HelpTopic[]> = {
  fr: [
    ...
    },
    {
      ...
      intro: "La rubrique « Progression musicale » distingue la partition actuellement travaillée de la prochaine partition prévue. Son état indique exactement l’action à effectuer.",
      steps: [
        ...
        "Si l’ancienne partition est terminée, passez-la à « Terminée » : la partition suivante est alors automatiquement placée « En cours » sur son premier morceau.",
