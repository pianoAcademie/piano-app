...
const TOPICS: Record<UiLanguage, HelpTopic[]> = {
  fr: [
    ...
    {
      id: "student-repertoire",
      icon: "♫",
      title: "Choisir la partition à remettre et contrôler le niveau",
      question: "Quelle partition donner à l’élève et comment suivre son niveau actuel ?",
      keywords: ["partition", "morceau", "niveau", "actuel", "progression", "musicale", "vidéo", "pédagogique", "remise", "donner", "élève"],
      intro: "La rubrique « Progression musicale » distingue la partition actuellement travaillée de la prochaine partition prévue. Chaque état correspond à une étape précise du suivi.",
      steps: [
        "Ouvrez {{planning}}, sélectionnez le cours, puis repérez l’élève dans la liste des présences.",
        "Dépliez la rubrique « Progression musicale » sous le nom de l’élève.",
        "Repérez l’état de la partition : « En attente » signifie qu’elle est prévue pour plus tard ; « À remettre » qu’elle doit être donnée à l’élève ; « Remise » qu’elle a été physiquement donnée ; « En cours » qu’elle est actuellement travaillée ; « Terminée » que son travail est achevé.",
        "Contrôlez le niveau actuel : la partition marquée « En cours » est celle que l’élève travaille maintenant. Le champ « Morceau travaillé » précise où il en est dans cette partition.",
        "Ancien élève : lors d’une réinscription à partir du degré 3, la partition du devis est la prochaine partition. Par exemple, degré 4 au devis : degré 3 en cours et degré 4 en attente, sauf si le suivi pédagogique indique déjà une autre progression. Choisissez le morceau que l’élève continue à travailler.",
        "Degrés 1 et 2 : partition précédente = « Aucune — sans objet » (N/A). Il ne faut créer aucune partition précédente ni déduire un degré inférieur. La partition du devis est celle à remettre et à travailler ; cela ne signifie pas que l’élève n’a aucune partition.",
        "Si le degré affiché est incorrect, choisissez la bonne partition dans « Degré / partition », puis enregistrez. Cette correction est tracée et ne modifie ni le devis ni la facturation.",
        "Quand l’ancienne partition est terminée, validez sa fin : la suivante devient « À remettre » si elle n’a pas encore été donnée, ou « En cours » sur son premier morceau si la remise physique est déjà enregistrée.",
        "Nouvel élève : la partition du devis est directement celle à remettre et à commencer, quel que soit son degré. On ne lui attribue pas automatiquement la partition du degré précédent.",
        "Pour enregistrer une remise physique, ouvrez « Remise des partitions » depuis les présences. Vérifiez le cours concerné et l’élève, choisissez la partition effectivement donnée, puis appuyez sur « Confirmer la remise à l’élève ».",
        "Dans « Mes partitions », les élèves sont filtrés par cours. Le bloc « Quantités à récupérer à Richelieu » est replié : ouvrez-le pour préparer puis confirmer votre retrait réel. « Préparer le retrait » ne confirme pas une remise à l’élève. L’historique des retraits, retours et remises est également replié.",
        "Sélectionnez ensuite le morceau travaillé. Si une vidéo pédagogique est associée au morceau, le lien « Voir la vidéo » apparaît.",
        "Ajoutez si besoin une note pédagogique, puis appuyez sur « Enregistrer la progression » après chaque modification.",
      ],
      note: "Ne déduisez pas un changement de degré uniquement à partir du dernier morceau : validez pédagogiquement que la partition en cours est terminée. Toute correction de partition conserve l’ancien et le nouveau degré dans l’historique avec l’auteur et la date. Les partitions terminées restent également conservées.",
      href: "/prof?tab=planning",
      action: "Ouvrir {{planning}}",
    },
    {
  ...
  en: [
    ...
    },
    {
      id: "student-repertoire",
      icon: "♫",
      title: "Choose the book to hand out and check the level",
      question: "Which sheet-music book should I give the student, and how do I track their current level?",
      keywords: ["sheet music", "book", "piece", "level", "current", "repertoire", "progress", "video", "hand out", "student"],
      intro: "The “Musical progress” section distinguishes the book currently being studied from the next planned book. Its status tells you exactly what action is required.",
      steps: [
        "Open {{planning}}, select the lesson, then find the student in the attendance list.",
        "Expand the “Musical progress” section under the student’s name.",
        "Check the current level: the book marked “In progress” is the one the student is studying now. The “Current piece” field shows their position in that book.",
        "For re-enrolment from degree 3 onward, the previous-degree book is shown “In progress” and the book from the quote remains “Waiting”. Select the piece the student will continue studying.",
        "If the displayed degree is wrong, choose the correct book under “Degree / book”, then save. This correction is logged and changes neither the quote nor billing.",
        "If the previous book is finished, mark it “Completed”: the next book is then automatically set to “In progress” on its first piece.",
        "For new students, “To be handed out” means the book can be given. Mark it “Handed out” when physically delivered, then “In progress” when study begins.",
        "Then select the current piece. If a teaching video is linked to it, a “Watch video” link appears.",
        "Add a teaching note if required, then press “Save progress” after each change.",
      ],
      note: "Do not infer a level change from the last piece alone: first confirm pedagogically that the current book is complete. Every book correction keeps the old and new degree in the history with its author and date. Completed books also remain in the history.",
      href: "/prof?tab=planning",
      action: "Open {{planning}}",
    },
    {
