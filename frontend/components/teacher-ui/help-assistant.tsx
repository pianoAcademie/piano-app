...
const TOPICS: Record<UiLanguage, HelpTopic[]> = {
  fr: [
    ...
    },
    {
      ...
      note: "Ne déduisez pas un changement de degré uniquement à partir du dernier morceau : validez pédagogiquement que la partition en cours est terminée. Si le degré issu du devis est incorrect, contactez l’administration : elle peut corriger la partition prévue sur la fiche élève sans modifier le devis d’origine. Les partitions terminées restent conservées dans l’historique administratif.",
      href: "/prof?tab=planning",
      action: "Ouvrir {{planning}}",
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      note: "Do not infer a level change from the last piece alone: first confirm pedagogically that the current book is complete. If the degree from the quote is wrong, contact the administration: it can correct the planned book on the student record without altering the original quote. Completed books remain in the administrative history.",
      href: "/prof?tab=planning",
      action: "Open {{planning}}",
    },
    {
