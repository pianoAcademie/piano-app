  ...
  fr: [
    ...
    },
    {
      ...
      steps: [
        ...
        "Lors d’une réinscription à partir du degré 3, la partition du degré précédent est proposée « En cours » et la partition du devis reste « En attente ». Choisissez le morceau que l’élève va continuer à travailler.",
        ...
        "Si l’ancienne partition est terminée, passez-la à « Terminée » : la partition suivante est alors automatiquement placée « En cours » sur son premier morceau. Vérifiez qu’elle a bien été remise à l’élève ; sinon, sélectionnez « À remettre » jusqu’à sa remise physique.",
        "Pour les nouveaux élèves, « À remettre » signifie que la partition peut être donnée. Au moment de la remise physique, passez son état à « Remise », puis à « En cours » lorsqu’elle est travaillée.",
