  ...
  fr: [
    ...
    },
    {
      ...
      steps: [
        ...
        "Pour une nouvelle partition, suivez son état : « En attente » signifie qu’elle est prévue mais ne doit pas encore être donnée ; « À remettre » signifie qu’elle peut être remise à l’élève.",
        "Au moment de la remise physique, passez son état à « Remise ». Dès que l’élève commence à la travailler, passez-la à « En cours » et marquez l’ancienne partition « Terminée ».",
      ...
      note: "Ne déduisez pas un changement de degré uniquement à partir du dernier morceau : validez pédagogiquement que la partition en cours est terminée. Si aucune partition n’apparaît, si deux partitions sont marquées « En cours » ou si le niveau affiché semble incorrect, contactez l’administration avant toute remise. Les partitions terminées restent conservées dans l’historique administratif.",
      href: "/prof?tab=planning",
      action: "Ouvrir {{planning}}",
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      steps: [
        ...
        "For a new book, follow its status: “Waiting” means it is planned but must not be handed out yet; “To be handed out” means it can be given to the student.",
        "When you physically hand it out, change its status to “Handed out”. When the student starts studying it, change it to “In progress” and mark the previous book “Completed”.",
      ...
      note: "Do not infer a level change from the last piece alone: first confirm pedagogically that the current book is complete. If no book is shown, two books are marked “In progress”, or the displayed level seems wrong, contact the administration before handing anything out. Completed books remain in the administrative history.",
      href: "/prof?tab=planning",
      action: "Open {{planning}}",
    },
    {
