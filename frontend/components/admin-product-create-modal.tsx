...
export default function AdminProductCreateModal({
  ...
  return (
    <section className="modal-overlay">
      <ModalA11yFrame className="modal-panel modal-day-details" label="Ajouter produit" closeHref={closeHref}>
        ...
        <section className="modal-card">
          <form action={createAction} className="grid cols-3 config-form-grid">
