...
def _default_template_ref_for_usage_context(usage_context: str) -> str:
...
def _settings_template_ref_for_usage_context(settings_payload: dict[str, object], usage_context: str) -> str:
    if usage_context == USAGE_CONTEXT_QUOTE_REMINDER:
