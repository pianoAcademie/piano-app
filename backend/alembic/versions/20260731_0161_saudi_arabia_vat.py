"""add Saudi Arabia VAT rules

Revision ID: 20260731_0161
Revises: 20260731_0160
...
revision = "20260731_0161"
down_revision = "20260731_0160"
branch_labels = None
depends_on = None
    ...
    op.execute(
        ...
        WHERE NOT EXISTS (
            ...
            WHERE existing.country_code = 'SA'
              ...
              AND existing.valid_from = DATE '2018-01-01'
        );
        ...
        WHERE NOT EXISTS (
            ...
            WHERE existing.country_code = 'SA'
              AND existing.service_code = supported_services.service_code
              AND existing.valid_from = DATE '2020-07-01'
        );
        """
    )
